    ...
    <div class="box-body pad">
        <?php if (!empty($categories)): ?>
            ...
            <?php foreach ($categories as $category): ?>
                ...
                <li class="categories-list__item <?= ($category->getId() === $active_id)? 'active' : ''?> <?= (!$category->isEnabled()) ? 'bg-pink--horizontal-gradient' : '' ?>" data-key="<?= $category->getId() ?>" data-position="<?= $category->position ?>" data-title="<?= $category->title ?>"
